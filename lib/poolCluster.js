...
var poolCluster = function(config) {
...
poolCluster.prototype.add = function(name, config) {
    return promiseCallback.apply(this.poolCluster, ['add', arguments]);
};
...
poolCluster.prototype.of = function(pattern, selector) {
    return promiseCallback.apply(this.poolCluster, ['of', arguments]);
};

poolCluster.prototype.query = function(sql, values) {
    return promiseCallback.apply(this.poolCluster, ['query', arguments]);
};
